...
import { VuIdentityExplanationHeader , VuIdentityExplanationHeaderProps} from './VuIdentityExplanationHeader';

export interface VuIdentityExplanationProps {
	header: VuIdentityExplanationHeaderProps;
...
export default class VuIdentityExplanation extends React.Component<VuIdentityExplanationProps> {
	render() {
		return (
				...
				<Fragment>
					...
					<SafeAreaView style={commonStyles.view.area}>
						<View {...this.props.viewProps} style={[styles.body, this.props.viewProps?.style]}>
							...
							{this.props.image ? <Image style={styles.image} source={this.props.image} />  : null}
